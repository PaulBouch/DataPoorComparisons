...
pb.spict = function(data, Use.n.prior, Use.r.prior, Use.k.prior, Use.q.prior,
  ...
  results_spict = setNames(data.frame(matrix(ncol = 47, nrow = 0)), c("Stock", "Method", "FixN2",
                                                                       "Use.r", "Use.k", "Use.q",
  ...
  results_spict [1,1:17] = c(Stock, "SPICT", Use.n.prior, Use.r.prior,
...
results_bsm = data.frame(Stock, "CMSY", "Y", "Y", "Y", "Y",pb.resilience, 
                          pb.r.low, pb.r.hi,  pb.k.low, pb.k.hi, 
                          pb.log.k, pb.log.k.sd, 
                          pb.q.low, pb.q.hi, pb.log.q, pb.log.q.sd, 
...
results = pb.spict(data, Use.n.prior, Use.r.prior, Use.k.prior, Use.q.prior,
                   pb.log.r, pb.log.r.sd, pb.log.k, pb.log.k.sd,
                   pb.log.q, pb.log.q.sd)
